import {Title, Text, Divider, Group, Flex, Stack, Loader, Tooltip, ActionIcon, Select, Button} from "@mantine/core";
import {ReactNode, SVGProps, useState, useRef} from "react";
...
export const LogViewer = () => {
  ...
  const fetchLog = async () => {
    setLoading(true);
    try {
      const res = await fetch(`/api/fs/logs/shinkro.log`);
